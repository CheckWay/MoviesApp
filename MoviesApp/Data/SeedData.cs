                ...
                if (!_context.Actor.Any())
                {
                    _context.Actor.AddRange(
                        new Actor
                        {
                            Name = "Ilya",
                            Surname = "Kireev",
                            Birth = DateTime.Parse("1993-03-01")
                        },
                        new Actor
                        {
                            Name = "Evgenii",
                            Surname = "Zamanov",
                            Birth = DateTime.Parse("1960-06-15")
                        },
                        new Actor
                        {
                            Name = "Igor",
                            Surname = "Razzhivaikin",
                            Birth = DateTime.Parse("1978-04-12")
                        },
                        new Actor
                        {
                            Name = "Brad",
                            Surname = "Pitt",
                            Birth = DateTime.Parse("1999-03-12")
                        },
                        new Actor
                        {
                            Name = "Nicolas",
                            Surname = "Cage",
                            Birth = DateTime.Parse("1989-11-20")
                        }
                    );
